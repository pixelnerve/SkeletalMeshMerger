...
static void ToMergeParams2(const TArray<FSkelMeshMergeUVTransformMapping>& InUVTransformsPerMesh, TArray<FSkelMeshMergeUVTransforms>& OutUVTransformsPerMesh)
{
...
USkeletalMesh* UMeshMergeFunctionLibrary::MergeMeshes(const FSkeletalMeshMergeParams& Params)
{
	...
	ToMergeParams1(Params.MeshSectionMappings, SectionMappings);
	ToMergeParams2(Params.UVTransformsPerMesh, UvTransforms);
